...
export default function BookingPage() {
  ...
  if (submitted) {
    return (
      <main className="bg-zinc-950 min-h-screen pt-24 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            <a href="/" className="px-5 py-3 border border-zinc-700 hover:border-zinc-500 text-white font-semibold rounded-xl transition-colors text-sm">Go Home</a>
            <a href="/bikes" className="px-5 py-3 bg-blue-500 hover:bg-blue-400 text-white font-semibold rounded-xl transition-colors text-sm">Browse More</a>
          </div>
        </div>
      </main>
    );
  ...
  return (
    <main className="bg-zinc-950 min-h-screen pt-24 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mb-10">
          <p className="text-blue-400 font-semibold text-sm tracking-wider uppercase mb-2">Schedule Your Ride</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
              <div className="w-7 h-7 bg-blue-500/20 rounded-lg flex items-center justify-center text-blue-400 text-sm font-black">1</div> Select Motorcycle
            </h2>
            <div className="relative">
              <select value={form.bike_id} onChange={e => setForm(f => ({ ...f, bike_id: e.target.value }))}
                className="w-full appearance-none pl-4 pr-10 py-3.5 bg-zinc-800 border border-zinc-700 text-white text-sm rounded-xl focus:outline-none focus:border-blue-500 cursor-pointer">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
              <div className="w-7 h-7 bg-blue-500/20 rounded-lg flex items-center justify-center text-blue-400 text-sm font-black">2</div> Choose Date & Time
            </h2>
              ...
              <div>
                ...
                <div className="relative">
                  <select required value={form.preferred_time} onChange={e => setForm(f => ({ ...f, preferred_time: e.target.value }))}
                    className="w-full appearance-none pl-4 pr-10 py-3 bg-zinc-800 border border-zinc-700 text-white text-sm rounded-xl focus:outline-none focus:border-blue-500 cursor-pointer">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-6">
            <h2 className="text-lg font-bold text-white mb-4 flex items-center gap-2">
              <div className="w-7 h-7 bg-blue-500/20 rounded-lg flex items-center justify-center text-blue-400 text-sm font-black">3</div> Your Details
            </h2>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
          ...
          <button type="submit" disabled={loading}
            className="w-full py-4 bg-blue-500 hover:bg-blue-400 disabled:bg-blue-500/50 text-white font-bold text-base rounded-xl transition-all flex items-center justify-center gap-2">
